        ...
        <div className={styles.Question}>
            <div className={styles.Content}>
                <section className={styles.questionHeader}>
                    <h1>
                        Cannot chagne the dorm in the elements panel while
                        source is paused in Chrome 96 dev tools - do I miss a
                        setting?
                    </h1>
                    ...
                    <div className={styles.postLayout}>
                        ...
                        <div className={styles.postCell}>
                            <div className={styles.postBody}>
                                <p>
                                    Is there any way to revert or undo git pull
                                    so that my source/repos will come to old
                                    state that was before doing git pull ? I
                                    want to do this because it merged some files
                                    which I didnt want to do so, but only merge
                                    other remaining files. So, I want to get
                                    those files back, is that possible?
                                </p>
                            </div>
